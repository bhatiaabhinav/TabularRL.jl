...
export QLearner, QLearnerWithExperienceReplay
...
mutable struct QLearnerWithExperienceReplay <: AbstractHook
    ...
    QLearnerWithExperienceReplay(π::AbstractPolicy{Int, Int}, q::Matrix{Float64}, γ::Float64) = new(π, q, γ, zeros(Int, size(q)), 1, Dict{Int, CircularBuffer{Tuple{Int, Int, Float64, Int, Bool}}}())
end
